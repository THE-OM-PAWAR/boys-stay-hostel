...
export const metadata: Metadata = {
  ...
  title: {
    default: "Best Hostel in Bhopal | Jain's Boy's Stay MP Nagar - Luxury & Secure Accommodation",
    template: "%s | Jain's Boy's Stay Bhopal"
  },
  description:
    "Jain's Boy's Stay hostel - Best luxury boys hostel in Bhopal, MP Nagar. Fully air-cooled campus, AC rooms, gym, yoga room, RO water, WiFi, entertainment room, pure veg food, 24/7 security. Top-rated hostel near MP Nagar Bhopal. Book now!",
  keywords: [
  ...
  authors: [{ name: "Jain's Boy's Stay" }],
  creator: "Jain's Boy's Stay",
  publisher: "Jain's Boy's Stay",
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
  ...
  openGraph: {
    ...
    locale: 'en_IN',
    url: siteUrl,
    siteName: "Jain's Boy's Stay",
    title: "Best Hostel in Bhopal | Jain's Boy's Stay MP Nagar - Luxury & Secure",
    description: "Jain's Boy's Stay - Best luxury boys hostel in Bhopal, MP Nagar. Fully air-cooled campus, AC rooms, gym, yoga room, RO water, WiFi, entertainment room, pure veg food, 24/7 security. Top-rated hostel near MP Nagar Bhopal.",
    images: [
      {
        url: `${siteUrl}/hero.png`,
        width: 1200,
        height: 630,
        alt: "Jain's Boy's Stay - Best Hostel in Bhopal MP Nagar",
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: "Best Hostel in Bhopal | Jain's Boy's Stay MP Nagar",
    description: "Jain's Boy's Stay - Best luxury boys hostel in Bhopal, MP Nagar. Fully air-cooled campus, AC rooms, gym, yoga room, RO water, WiFi, entertainment room, pure veg food, 24/7 security.",
