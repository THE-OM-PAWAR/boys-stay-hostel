...
import { Shield, Bed, Gift, ArrowRight, Lock, Wifi, Users, Star } from 'lucide-react';
    ...
    <section className="h-screen md:h-auto flex items-center justify-center px-4 sm:px-6 md:px-8 bg-gradient-to-br from-purple-50 via-white to-pink-50 py-8 sm:py-12">
      <div className="max-w-6xl mx-auto w-full">
        ...
        >
          ...
          <div className="relative bg-gradient-to-br from-purple-500 to-pink-500 p-4 sm:p-6 md:p-0 md:h-full md:min-h-[500px]">
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm sm:text-base md:text-lg font-semibold text-purple-900">Girls Stay</span>
              </div>
            </motion.div>
          ...
          {/* Info Section - Right on Desktop, Bottom on Mobile - Dark Theme */}
          <div className="bg-gray-900 p-4 sm:p-6 md:p-8 space-y-4 md:flex md:flex-col md:justify-center">
            {/* Price/Title Section */}
            <div className="text-center md:text-left space-y-2">
              ...
              >
                <span className="text-white text-sm sm:text-base font-semibold">From $45/night</span>
              </motion.div>
            ...
            {/* Description */}
            <motion.p
              className="text-sm sm:text-base md:text-left text-gray-400 text-center md:text-left leading-relaxed max-w-md mx-auto md:mx-0"
              initial={{ opacity: 0, y: 10 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.5, delay: 0.9 }}
            >
              A safe, comfortable, and empowering space designed exclusively for women. Experience premium facilities and a vibrant community.
            </motion.p>
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-lg sm:text-xl font-bold text-white">98%</p>
              </div>
            </motion.div>
            ...
            >
              <Link href="/rooms">
                <motion.button
                  className="w-full py-3 sm:py-3.5 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl font-semibold text-sm sm:text-base shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 group"
